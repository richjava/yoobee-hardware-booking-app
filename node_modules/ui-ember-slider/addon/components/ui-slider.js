...
const apiSurface = [...numericApiSurface, .
..
booleanApiSurface,
...
stringApiSurface,
...
initializeJqueryComponent()
{
    ...
    this._slider = this.$(`#slider - value -
    ${elementId}
`).
    slider(options);
}
