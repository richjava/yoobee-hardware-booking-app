...
{
  const widgetWidth = $(`#${this.get('elementId')}
`).
  innerWidth();
...
_defaultValue()
{
    ...
    if (defaultValue) {
      if (typeOf(defaultValue) === 'object') {
        ...
        to
        mini - date - change
        's "defaultValue" was invalid: `, defaultValue);
...
today: computed(function () {
  ...
  // is component's internal value equal to the containers value
    _hasChanged
:
computed('initialValue', '_value', function () {
...
4,
    _numDateChoices
:
computed('numDateChoices', '_autoChoiceNumber', function () {
...
0,
    _dateRangeOrigin
:
computed('rangeToValuePosition', '_defaultValue', function () {
  ...
  switch (rangeToValuePosition) {
    ...
    dateRange
:
computed('_dateRangeOffset', '_numDateChoices', '_dateRangeOrigin', function () {
