            ...
            $scope.panesA = [
                {
                    id: 'pane-1a',
                    header: 'Pane 1',
                    content: 'ellentesque facilisis. Nulla imperdiet sit amet magna.',
                    isExpanded: true
                },
                {
                    id: 'pane-2a',
                ...
                },
                {
                    id: 'pane-3a',
                    header: 'Pane 3',
                    content: 'Aliquam erat ac ipsum.',

                    subpanes: [
                        {
                            id: 'subpane-1a',
                            header: 'Subpane 1',
                            content: 'Quisque lorem tortor fringill.'
                        },
                        {
                            id: 'subpane-2a',
                            header: 'Subpane 2 (disabled)',
                            content: 'Curabitur et ligula. Ut m.',
                            isDisabled: true
                        }
                    ]
                }
