...
(function (e, m, f) {
    ...
    TableTools.prototype = {
        fnGetSelected: function () {
            ...
            return !0 === this.s.dt.aoData[this.s.dt.oInstance.fnGetPosition(a)]._DTTT_selected ? !0 : !1
        ...
        fnGetTitle: function (a) {
            ...
            h = 0;
            for (f = a.length; h < f; h++)a[h] && (d = b[h].nTh.offsetWidth, e += d, c.push(d));
            h = 0;
            for (f = c.length; h < f; h++)c[h] /=
                e;
            return c.join("\t")
        ...
        _fnCreateButton: function (a, b) {
            ...
            var c, d, e;
            b ? (c = "default" !== a.sTag ? a.sTag : this.s.tags.collection.button, d = "default" !== a.sLinerTag ? a.sLiner : this.s.tags.collection.liner, e = this.classes.collection.buttons.normal) : (c = "default" !==
            a.sTag ? a.sTag : this.s.tags.button, d = "default" !== a.sLinerTag ? a.sLiner : this.s.tags.liner, e = this.classes.buttons.normal);
            c = f.createElement(c);
            d = f.createElement(d);
            ...
            for (var a = TableTools._aInstances, b = 0, c = a.length; b < c; b++)if (this.dom.table ==
            ...
            var c = this, d = e(a).offset(), g = b._collection, h = d.left, d = d.top + e(a).outerHeight(), p = e(m).height(), j = e(f).height(), k = e(m).width(), n = e(f).width();
            ...
            d + k > j && (g.style.top = d - k - e(a).outerHeight() + "px");
            this.dom.collection.collection = g;
            this.dom.collection.background =
                l;
            setTimeout(function () {
            ...
            }), this.dom.collection.collection =
            ...
            if (this.s.master) {
                ...
                e("tr", b.nTBody).live("click", function (c) {
                    if (this.parentNode == b.nTBody && null !== b.oInstance.fnGetData(this) && (null === a.s.select.preRowSelect || a.s.select.preRowSelect.call(a, c)))a.fnIsSelected(this) ? a._fnRowDeselect(this) : "single" == a.s.select.type ? (a.fnSelectNone(), a._fnRowSelect(this)) : "multi" == a.s.select.type && a._fnRowSelect(this)
                });
                b.oApi._fnCallbackReg(b,
                    "aoRowCreatedCallback", function (c, d, g) {
            ...
            a.length ? null : a[0].nTr, c = 0, d = a.length; c < d; c++)a[c].nTr && a[c]._DTTT_selected && e(a[c].nTr).removeClass(this.classes.select.row), a[c]._DTTT_selected = !1;
            ...
            if (a.nodeName)c = this.s.dt.oInstance.fnGetPosition(a), b.push(this.s.dt.aoData[c]); else if ("undefined" !== typeof a.length) {
                d = 0;
                for (e = a.length; d < e; d++)a[d].nodeName ? (c = this.s.dt.oInstance.fnGetPosition(a[d]),
            ...
            e(a).click(function () {
                ...
                b.fnComplete !==
                null && b.fnComplete.call(c, a, b, null, null);
            ...
            var b, c, d, g, h, f = [], j = "", k = this.s.dt, n, l = RegExp(a.sFieldBoundary, "g"), m = this._fnColumnTargets(a.mColumns);
            d = "undefined" != typeof a.bSelectedOnly ?
                a.bSelectedOnly : !1;
            if (a.bHeader) {
                h = [];
                b = 0;
            ...
            for (g = o.length; d < g; d++) {
                ...
                b = 0;
                for (c =
                         k.aoColumns.length; b < c; b++)m[b] && (j = k.oApi._fnGetCellData(k, o[d], b, "display"), a.fnCellRender ? j = a.fnCellRender(j, b, n, o[d]) + "" : "string" == typeof j ? (j = j.replace(/\n/g, " "), j = j.replace(/<img.*?\s+alt\s*=\s*(?:"([^"]+)"|'([^']+)'|([^\s>]+)).*?>/gi, "$1$2$3"), j = j.replace(/<.*?>/g, "")) : j += "", j = j.replace(/^\s+/, "").replace(/\s+$/, ""), j = this._fnHtmlDecode(j), h.push(this._fnBoundData(j, a.sFieldBoundary, l)));
                f.push(h.join(a.sFieldSeperator));
            ...
            c = 0;
            for (d = a.length; c < d; c++)e = a[c].lastIndexOf("&"), -1 != e && (8 <= a[c].length && e > a[c].length - 8) && (a[c].substr(e), a[c] = a[c].substr(0, e)), b.innerHTML = a[c], h += b.childNodes[0].nodeValue;
            return h
            ...
            for (d in c)if ("i" != d && "t" != d && 1 == d.length)for (var g = 0, h = c[d].length; g < h; g++)this.dom.print.hidden.push({
                node: c[d][g],
                display: "block"
            }), c[d][g].style.display = "none";
            e(f.body).addClass(this.classes.print.body);
            "" !== a.sInfo && this.fnInfo(a.sInfo,
                3E3);
            ...
            "" !== a.oScroll.sY && (b.style.height = e(a.nTable).outerHeight() + "px", b.style.overflow =
                "visible")
            ...
            for (var b = this.dom.print.hidden, c = a.parentNode, d = c.childNodes,
                     g = 0, h = d.length; g < h; g++)if (d[g] != a && 1 == d[g].nodeType) {
