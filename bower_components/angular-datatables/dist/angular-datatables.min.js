...
"undefined" != typeof module && "undefined" != typeof exports && module.exports === exports && (module.exports = "datatables"), function (a, b, c, d) {
    ...
    function l() {
        function a(a) {
            return h.loadingTemplate = a, h
        }

        function b(a) {
            return c.ajax({
                dataType: "json", url: a, success: function (a) {
                    c.extend(!0, c.fn.DataTable.defaults, {language: a})
                }
            }), h
        }

        function d(a) {
            return c.extend(!0, c.fn.DataTable.defaults, {language: a}), h
        }

        function e(a) {
            return c.extend(c.fn.DataTable.defaults, {displayLength: a}), h
        }

        function f(a) {
            return h.bootstrapOptions = a, h
        }

        function g(a) {
            return c.extend(c.fn.DataTable.defaults, {dom: a}), h
        }
